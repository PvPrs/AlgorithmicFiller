...
** loops through the grid and find first occurrence of an already existent token
** Checks the surrounding squares of the occurred token, if only 1 token overlaps a 'piece token' set piece!
** @param map
** @param piece
** @return
*/
